<template>
   <v-card class="pa-2 pb-0 border-primary border-opacity-100 bg-white elevation-1 rounded-e passenger-card">
      ...
      <section class="bg-grey-lighten-4 elevation-1 mx-n2 d-flex">
         <RouterLink :to="{ name: 'passenger-offers', params: { id: props.passenger?.id } }"  v-if="(Auth.isAnyAdmins || isMyAdd(props.passenger))">
