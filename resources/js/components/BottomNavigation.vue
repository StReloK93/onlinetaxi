<template>
    <v-bottom-navigation color="primary"  class="text-center">
        <v-btn v-if="Auth.isDriver" :to="{ name: 'car-rides-auth-user' }">
            <v-icon>mdi-taxi</v-icon>
            <span style="width: 90px;" class="tw-leading-none">Mening qatnovlarim</span>
        </v-btn>
