...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Car::insert([
            ['car_company_id' => 1, 'name' => 'Cobalt'],
            ['car_company_id' => 1, 'name' => 'Matiz'],
            ['car_company_id' => 1, 'name' => 'Nexia'],
            ['car_company_id' => 1, 'name' => 'Nexia 2'],
            ['car_company_id' => 1, 'name' => 'Nexia 3'],
            ['car_company_id' => 1, 'name' => 'Gentra'],
            ['car_company_id' => 1, 'name' => 'Lacetti'],
            ['car_company_id' => 1, 'name' => 'Onix'],
            ['car_company_id' => 1, 'name' => 'Damas'],
            ['car_company_id' => 1, 'name' => 'Labo'],
            ['car_company_id' => 1, 'name' => 'Malibu 1'],
            ['car_company_id' => 1, 'name' => 'Malibu 2'],
            ['car_company_id' => 1, 'name' => 'Tracker'],
            ['car_company_id' => 1, 'name' => 'Equinox'],
            ['car_company_id' => 1, 'name' => 'Traverse'],
            ['car_company_id' => 1, 'name' => 'Tahoe'],
            ['car_company_id' => 1, 'name' => 'Captiva'],
        ]);
